...
open class SessionStepData: NSObject, NSCoding {
    ...
    open var networkState: Data? = nil
    ...
    open func copyTo(_ step: Step) -> Void {
        step.trialNumber = Int64(trialNumber)
        step.trialStepNumber = Int64(trialStepNumber)
        
        step.isLearning = isLearning
        
        step.isXOn = isXOn
        step.isYOn = isYOn
        step.isSrOn = isSrOn
        
        step.s1m1Weight = s1m1Weight
        step.s2m2Weight = s2m2Weight
        
        step.m1outActivation = m1outActivation
        step.m2outActivation = m2outActivation
        
        step.networkState = networkState
    }

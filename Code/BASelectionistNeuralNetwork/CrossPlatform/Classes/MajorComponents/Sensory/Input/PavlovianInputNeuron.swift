//
//  RespondentInputNeuron.swift
//  BASelectionistNeuralNetwork
//
//  Created by Tom Donaldson on 10/5/15.
//  
...
final public class RespondentInputNeuron: NSObject, RespondentSensoryInputNeuron {
...
} // end class RespondentInputNeuron

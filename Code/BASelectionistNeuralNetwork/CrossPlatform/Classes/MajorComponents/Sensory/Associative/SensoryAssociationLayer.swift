...
// SensoryAssociationLayer
//
// One parallel layer of sensory inter-neurons. 
//
final public class SensoryAssociationLayer: NSObject, NeuralLayer, ComputationalNode {
    ...
    @objc public required init?(coder aDecoder: NSCoder) {
        ...
        priv_neurons = aDecoder.decodeObject(forKey: SensoryAssociationLayer.key_neurons) as! [SensoryAssociativeNeuron]
    }
    
    @objc public func encode(with aCoder: NSCoder) {
        priv_node.encodeWithCoder(aCoder)
        aCoder.encode(priv_neurons, forKey: SensoryAssociationLayer.key_neurons)
    }
    ...
    //
    public func create(_ identifier: Identifier? = nil) -> SensoryInterneuron {
        precondition(!isStructureLocked)
        precondition(!network.isRegisteredNode(identifier))
        
        let neuron = SensoryAssociativeNeuron(environment: self, identifier: identifier)
    ...
    public subscript(index: Int) -> SensoryInterneuron {
    ...
    fileprivate var priv_neurons = [SensoryAssociativeNeuron]()
    
} // end class SensoryAssociationLayer

//
//  SensoryAssociativeNeuron.swift
...
final public class SensoryAssociativeNeuron: NSObject, SensoryInterneuron {
    ...
    @objc public required init?(coder aDecoder: NSCoder) {
        ...
        priv_publishedActivationLevel.rawValue =
            aDecoder.decodeDouble(forKey: SensoryAssociativeNeuron.key_publishedActivation)
        priv_newActivationLevel.rawValue =
            aDecoder.decodeDouble(forKey: SensoryAssociativeNeuron.key_newActivation)
    }
    ...
    @objc public func encode(with aCoder: NSCoder) {
        ...
        aCoder.encode(priv_publishedActivationLevel.rawValue,
            forKey: SensoryAssociativeNeuron.key_publishedActivation)
        aCoder.encode(priv_newActivationLevel.rawValue,
            forKey: SensoryAssociativeNeuron.key_newActivation)
    }
    ...
    public func receiveExcitation(_ sensor: SensoryInputNeuron) -> Void {
        priv_neuronBody.receiveExcitation(sensor)
    }
    public func receiveInhibition(_ sensor: SensoryInputNeuron) -> Void {
        priv_neuronBody.receiveInhibition(sensor)
    }
...
} // end class SensoryAssociativeNeuron
